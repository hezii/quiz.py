...
runQuest(q1, c1, u1, a1) #run the function "runQuest" and use (question 1, check 1, user answer 1 and correct answer 1)
runQuest(q2, c2, u2, a2) #run the function "runQuest" and use (question 2, check 2, user answer 2 and correct answer 2)
