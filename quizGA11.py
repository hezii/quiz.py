#import from quizGAdata (variables)
from quizGAdata import*


#Introduction to what the quiz is about
print("""Hey, this quiz is about PewDiePie, he is the most famous YouTuber on YouTube.
He appeals to the younger generations with his innovative content. He is gone through
almost every single era on YouTube. Felix (PewDiePie), has also been through a lot of
controversy because of the content he produces and has mainly been under the heat 
from liberal media outlets. This being said, personally, PewDiePie is my all time
favorite YouTuber as he is a wholesome, humble, innovative and independant person.
...
elif score == 9: #else if score calulated is equal to 90, then...
    print("""
...
elif score == 8: #else if score calulated is equal to 80, then...
    print("""
    oof
...
elif score == 7: #else if score calulated is equal to 70, then...
    print("""
...
elif score == 6: #else if score calulated is equal to 60, then...
    print("""
...
elif score == 5: #else if score calulated is equal to 50, then...
    print("""At least you didn't get a 4, but go ahead and... subscribe to PewDiePie
    
    """)

elif score == 4: #else if score calulated is equal to 40, then...
    print("""
...
else: #else socre that is calculated is less than 40, then...
    print("""You clearly support T-Series and you do not deserve to be taking this quiz.
    Please close the quiz and unsubscribe from T-Series.
    -death to all those who watches T Gay (and thats okay- Lev)
